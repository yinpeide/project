...
<body>
	...
	<div class="easyui-panel" title="New Topic" style="width:400px">
	    ...
	    <form id="ff" class="easyui-form" method="post" data-options="novalidate:true">
	    	<table cellpadding="5">
	    		...
	    		<tr>
	    			<td>Email:</td>
	    			<td><input class="easyui-textbox" type="text" name="email" data-options="required:true,validType:'email',invalidMessage:'请输入邮件格式'"></input></td>
	    		</tr>
	    		<tr>
	    			<td>Subject:</td>
	...
	<script>
		function submitForm(){
			$('#ff').form('submit',{
				onSubmit:function(){
					console.log($(this).form('enableValidation'));
